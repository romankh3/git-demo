...
Спасибо за внимание. Кстати вот изменение из браузера.

Добавляю пару строк в ридми. Это первая.
Это вторая :)

Кто-то(я) опять паралельно отредачил файл с которым я работаю в идее. Ну что же, проверим, что из этого выйдет.
