...
Также проект содержит коммиты для статьи про работу в гите через Intellij IDEA.
...
### Addition 
Добавили что-то просто для коммита

#### Addition #2 
Создаем новый коммит для обработки/разрешения конфликта
