...
Новые исправлено через браузер проекта
...
Спасибо за внимание.
+++ тут добавлен коммент через локальный иде

!!! этот тест добавлен через браузер для конфликта
!!! И еще такой же - первый был без коммента при коммите
!!! И еще 
